...
public class NumberImageView extends AppCompatImageView {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.NumberImageView);
            text = array.getString(R.styleable.NumberImageView_numberText);
            text = TextUtils.isEmpty(text) ? "0" : text;
            textSize = array.getDimensionPixelSize(R.styleable.NumberImageView_numberTextSize, textSize);
            textColor = array.getColor(R.styleable.NumberImageView_numberTextColor, textColor);
            solidColor = array.getColor(R.styleable.NumberImageView_numberSolidColor, solidColor);
            textMarginTop = array.getDimensionPixelSize(R.styleable.NumberImageView_numberMarginTop, textMarginTop);
            textMarginRight = array.getDimensionPixelSize(R.styleable.NumberImageView_numberMarginRight, textMarginRight);
        }
    }
